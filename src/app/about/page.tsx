      ...
      <div className="md:flex">
        ...
        <div className="md:w-4/5">
          <div className="mb-5">
            ...
            <p className="mt-2 text-md text-justify">
              <span className="font-bold">
                My Name is Muhammad <span className="text-red-700 md:text-black">Azmi</span>
              </span>
              ...
              <ul className="">
                <li className="border-b-2 pb-2">
                  <div className="flex items-center gap-x-3">
                    ...
                    <h2 className="font-bold text-2xl text-black">Coding Bootcamp</h2>
                  </div>
                  <div className="pl-7">
                    <h3 className="font-bold">Dumbways Indonesia</h3>
                    <p>Fullstack Developer</p>
                    <p className="text-black/60">FEB 2023 - MAY 2023</p>
                  </div>
                </li>
                <li className="border-b-2 pb-2">
                  <div className="flex items-center gap-x-3">
                    <FaChevronCircleRight className="text-red-700" />
                    <h2 className="font-bold text-2xl text-black">Vocational School</h2>
                  </div>
                  <div className="pl-7">
                    <h3 className="font-bold">SMKN 4 BANJARMASIN</h3>
                    <p>Software Engineering</p>
                    <p className="text-black/60">JUNI 2019 - JUNI 2023</p>
                  </div>
                </li>
              </ul>
            </div>
          ...
          <div>
            ...
            <div className="pt-3 gap-3 text-transparent/80 flex flex-wrap md:flex-row md:gap-x-6">
              <span className="flex gap-x-3 bg-gray-200 px-2 py-2 items-center justify-start md:gap-0 md:px-0 md:py-0 md:bg-transparent md:flex-col md:items-start">
