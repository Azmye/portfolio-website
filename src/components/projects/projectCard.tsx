  ...
  return (
    <div className="flex flex-col border-b-2 pb-2 mb-5 md:gap-x-3 md:flex-row">
      ...
      <div className="flex flex-col justify-between md:w-3/6 dark:text-white">
        ...
        <div>
          <h3 className="font-bold">Study Case : </h3>
          <p>{props.case}</p>
        </div>
        <div>
        ...
        <div className="mt-2">
          ...
          <ul className="flex gap-x-3 mt-2">
            {props.repo ? (
              ...
              <>
                <li>
                  <Link className="px-2 py-1 bg-blue-500 text-white rounded-md" href={props.client}>
                    Client
                  </Link>
                </li>
                <li>
                  <Link className="px-2 py-1 bg-gray-500 text-white rounded-md" href={props.server}>
                    Server
                  </Link>
                </li>
              </>
